...
class Chatbot < ApplicationRecord
  ...
  def start
    ...
    if chatbot_type == 'Group A - Helpful Chatbot'
      conversation << { message: HELPFUL_WELCOME, from: 'chatbot' }
      conversation << { message: HELPFUL_PROMPT, from: 'chatbot' }
    elsif chatbot_type == 'Group B - Neutral Chatbot'
      conversation << { message: NEUTRAL_WELCOME, from: 'chatbot' }
  ...
  HELPFUL_WELCOME = "Hi there, I'm Chatty the Chatbot. I'll be here to keep you company throughout your test and provide some extra support"
  HELPFUL_PROMPT = 'Would you like to hear some strategies to help you with your test?'
  HELPFUL_RESPONSES = [
  ...
  NEUTRAL_WELCOME = "Hi there, I'm Chatty the Chatbot. I'll be here to keep you company throughout your test"
  NEUTRAL_PROMPT = 'Would you like to hear a comment about research studies?'
  NEUTRAL_RESPONSES = [
